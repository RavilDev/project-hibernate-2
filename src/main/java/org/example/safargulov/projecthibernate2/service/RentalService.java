...
public class RentalService {
    ...
    public RentalService(BaseRepository<Rental, Integer> rentalRepo, StaffService staffService, CustomerService customerService, InventoryService inventoryService) {
